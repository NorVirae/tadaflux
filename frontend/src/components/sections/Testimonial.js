...
const Testimonial = ({
  ...
  const sectionHeader = {
    title: 'Testimonials',
    paragraph: 'From our clients all over the world.'
  };
          ...
          <div className={tilesClasses}>
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
                  <span className="testimonial-item-name text-color-high">~Roshywall GurgeZen</span>
            ...
            <div className="tiles-item reveal-from-left" data-reveal-delay="200">
              <div className="tiles-item-inner">
                ...
                <div className="testimonial-item-footer text-xs mt-32 mb-0 has-top-divider">
                  <span className="testimonial-item-name text-color-high">~Zen</span>
