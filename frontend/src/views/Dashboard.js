      ...
      <Container fluid>
                ...
                <Row>
                  <Col xs="5">
                    <div className="icon-big text-center icon-warning">
                      <i className="nc-icon nc nc-chart text-warning"></i>
                    </div>
                  </Col>
                  <Col xs="7">
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category text-success">GAIN</p>
                      <Card.Title className={"text-success"} as="h4">+2%</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
        ...
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Profit</Card.Title>
                <p className="card-category">Dollars$</p>
              </Card.Header>
              <Card.Body>
                <div className="ct-chart" id="chartHours">
                  <ChartistGraph
                    data={{
                      ...
                      series: [
                        [0.5, 2, 3, 5, 7, 8, 20, 50],
                        [0.5, 3, 3, 33, 7, 8, 20, 50],
                        [0.5, 4, 3, 15, 7, 8, 20, 30],
                      ],
                    }}
                    type="Line"
                    options={{
              ...
              <Card.Footer>
                <div className="legend">
                  ...
                  gain <i className="fas fa-circle text-danger"></i>
                  loss <i className="fas fa-circle text-warning"></i>
                  Consolidation
                </div>
                <hr></hr>
                <div className="stats">
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Referral Statistics</Card.Title>
        ...
        <Row>
          <Col md="6">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Crypto Sales</Card.Title>
                <p className="card-category">All DeFi's including Taxes</p>
              </Card.Header>
              <Card.Body>
              ...
              <Card.Footer>
                <div className="legend">
                  <i className="fas fa-circle text-info"></i>
                  BTC <i className="fas fa-circle text-danger"></i>
                  ETH
                </div>
                <hr></hr>
                <div className="stats">
          ...
          <Col md="6">
            <Card className="card-tasks">
              <Card.Header>
                ...
                <p className="card-category">NFT's</p>
              </Card.Header>
              <Card.Body>
