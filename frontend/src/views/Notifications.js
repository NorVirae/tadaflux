          ...
          <Card.Body>
            <Row>
              <Col md="6">
                ...
                <Alert variant="info">
                  <span>You have Successfully Activated your account, Visit our plans Tab to see our Crypto Investment Plans</span>
                </Alert>
                <Alert variant="info">
                  <button
                    aria-hidden={true}
                  ...
                  <span><Link to={"/admin/plans"}>Get started...</Link></span>
                </Alert>
